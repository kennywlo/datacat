...
def main():
    ...
    ****************************************************
    ...
    try:
        ...
        if add_dependents:
            ...
            expected = OrderedDict([('successor.dataset', '{}'.format(update_dpks[0])),
                                    ('nIsTest', 1.0),
    ...
    **************************************************
    ...
    # try:
    #     added_before = client.path(path='/testpath/depGroup2_4;v=current')
    #     group_to_patch = client.path(path='/testpath/depGroup2_4;v=current')
